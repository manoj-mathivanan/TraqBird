...
public class prod extends AbstractExample {

  public static void main(String[] args) {
    prod example = new prod();
    example.run(args);
  }

  private void run(String[] args) {

    String endpointUri = "http://localhost:8886/TraqBird.svc/";
    ...
    //String persistenceUnitName = "traq" + JPAProvider.JPA_PROVIDER.caption;
    String persistenceUnitName = "traq";
    String namespace = "traq";
